...
namespace Greenhalgh_Lab_1
{
    public partial class Company : System.Web.UI.Page
    {
        ...
        {
            HttpUtility.HtmlEncode( txtCompanyName.Text = "Workplace Inc.");
            HttpUtility.HtmlEncode(txtCompanyAddress.Text = "2245 West Landing Drive");
            HttpUtility.HtmlEncode(txtCompanyPhone.Text = "555-096-6447");
            HttpUtility.HtmlEncode(txtContactFirstName.Text = "John");
            HttpUtility.HtmlEncode(txtContactLastName.Text = "Workman");
            HttpUtility.HtmlEncode(txtContactPhone.Text = "555-789-3893");
            HttpUtility.HtmlEncode(txtContactEmail.Text = "john.workman@workplace.com");
        }

        protected void btnCompanyClear_Click(object sender, EventArgs e)
        {
            HttpUtility.HtmlEncode(txtCompanyName.Text = "");
            HttpUtility.HtmlEncode(txtCompanyAddress.Text = "");
            HttpUtility.HtmlEncode(txtCompanyPhone.Text = "");
            HttpUtility.HtmlEncode(txtContactFirstName.Text = "");
            HttpUtility.HtmlEncode(txtContactLastName.Text = "");
            HttpUtility.HtmlEncode(txtContactPhone.Text = "");
            HttpUtility.HtmlEncode(txtContactEmail.Text = "");
