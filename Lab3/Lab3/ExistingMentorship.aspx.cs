...
namespace Greenhalgh_Lab_1
{
    public partial class ExistingMentorship : System.Web.UI.Page
    {
        ...
        { 
                ...
                while (queryResults.Read())
                {
                    HttpUtility.HtmlEncode(txtMentoredStudentFirstName.Text = queryResults["FirstName"].ToString());
                    HttpUtility.HtmlEncode(txtMentoredStudentLastName.Text = queryResults["LastName"].ToString());
                    HttpUtility.HtmlEncode(txtMentoredStudentEmail.Text = queryResults["EmailAddress"].ToString());
                    HttpUtility.HtmlEncode(txtMentoredStudentMajor.Text = queryResults["Major"].ToString());
                    HttpUtility.HtmlEncode(txtMentoredStudentGradeLevel.Text = queryResults["GradeLevel"].ToString());
                    HttpUtility.HtmlEncode( txtMentoredStudentEmployment.Text = queryResults["EmploymentStatus"].ToString());
                }
