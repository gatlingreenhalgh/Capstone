...
<h3>Apply Here For The Selected Scholarship</h3>
    ...
    <asp:Label ID="lblApplyLastName" runat="server" Text="Enter Your Last Name"></asp:Label>
        ...
        <br />
        <br />
     <asp:Label ID="lblApplyText" runat="server" Text="Enter Today's Date (mm/dd/yyyy)"></asp:Label>
        ...
        <br />
        <br />
    <asp:Label ID="lblApplyDate" runat="server" Text="Enter Today's Date (mm/dd/yyyy)"></asp:Label>
        ...
        <br />
        <!-- Create the buttons -->
    <asp:Button ID="btnApplyPopulate" runat="server" Text="Populate" OnClick="btnApplyPopulate_Click" CausesValidation="false"/>
    ...
    <asp:Label ID="lblError" runat="server" Text="Label" Visible="false">Either Application Already Exists or Student Doesn't Exist</asp:Label>
    </div>
