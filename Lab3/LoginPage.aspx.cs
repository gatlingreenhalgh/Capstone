...
namespace Lab2
{
    public partial class LoginPage : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
                ...
                {
                    lblStatus.Text = "You are Logged In";
                }
                else
                {
        ...
        protected void btnLogin_Click(object sender, EventArgs e)
        {
            ...
            commandsql.CommandText = "Lab3StoredProcedure";

            commandsql.Parameters.Add(new SqlParameter("@Username", HttpUtility.HtmlEncode(txtUsername.Text)));
            ...
            sqlCommand.Parameters.Add(new SqlParameter("@Username", HttpUtility.HtmlEncode(txtUsername.Text))); 
            ...
            SqlDataReader reader = sqlCommand.ExecuteReader(); // create a reader
                ...
                else
                {
                    ...
                    command.Parameters.Add(new SqlParameter("@student", HttpUtility.HtmlEncode(txtUsername.Text)));
                    ...
                    if (sqlreader.HasRows) // if the username exists, it will continue
                    {
                        ...
                        {
                            string storedStudentHash = sqlreader["StudentPass"].ToString(); // store the database password into this variable
