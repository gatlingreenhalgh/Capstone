...
namespace Greenhalgh_Lab_1
{
    public partial class NewScholarship : System.Web.UI.Page
    {
        ...
        {
            txtScholarshipTitle.Text = "Good Student Award";
            txtScholarshipAmount.Text = "$123,456,789";
            txtScholarshipYear.Text = "2022";
            txtScholarshipMemberFN.Text = "Bob";
            txtScholarshipMemberLN.Text = "Roberts";
        }
...
protected void btnScholarshipClear_Click(object sender, EventArgs e)
        {
            txtScholarshipTitle.Text = "";
            txtScholarshipAmount.Text = "";
            txtScholarshipYear.Text = "";
            txtScholarshipMemberFN.Text = "";
            txtScholarshipMemberLN.Text = "";
        }
    }
}