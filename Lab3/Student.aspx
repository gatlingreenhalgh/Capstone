...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Label ID="lblStudentJob" runat="server" Text="Did The Student/Will The Student Have a Job?"></asp:Label>
        ...
        <br />
        <br />
    <asp:Label ID="lblStudentUser" runat="server" Text="Username"></asp:Label>
        <asp:TextBox ID="txtStudentUser" runat="server"></asp:TextBox>
         <asp:RequiredFieldValidator 
                ID="RequiredFieldValidator1" 
                runat="server" 
                ErrorMessage="RequiredFieldValidator" ControlToValidate="txtStudentUser" ForeColor="Red" Text="Cannot be Blank" style="float:right;"></asp:RequiredFieldValidator>
        <br />
        <br />
        <br />
    <asp:Label ID="lblStudentPass" runat="server" Text="Password"></asp:Label>
        <asp:TextBox ID="txtStudentPass" runat="server"></asp:TextBox>
         <asp:RequiredFieldValidator 
                ID="RequiredFieldValidator2" 
                runat="server" 
                ErrorMessage="RequiredFieldValidator" ControlToValidate="txtStudentPass" ForeColor="Red" Text="Cannot be Blank" style="float:right;"></asp:RequiredFieldValidator>
        <br />
        <br />
        <br />
        <!-- Create the buttons -->
